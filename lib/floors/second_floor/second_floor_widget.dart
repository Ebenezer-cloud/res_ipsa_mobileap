...
import 'second_floor_model.dart';
export 'second_floor_model.dart';

class SecondFloorWidget extends StatefulWidget {
  const SecondFloorWidget({super.key});
...
class _SecondFloorWidgetState extends State<SecondFloorWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecondFloorModel());
